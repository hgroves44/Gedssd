...
//    void FillNtuple(G4double eventNumber, G4double stepNumber, G4double cryNumber, G4double detNumber, G4double depEnergy, G4double posx, G4double posy, G4double posz, G4double time);
    ...
    G4bool GetHitTrackerBool()  { return fHitTrackerBool;};
	 ...
	 void Gedssd  (G4bool val) { fGedssd   = val; } 
    // getter
	 ...
	 G4bool Gedssd  () { return fGedssd;   }
	 short segmenthisto[120];//This is a new addition in updated file on github to hold segment IDs to be transferred to reference for histos
...
//I am not sure if I need to have this many detectors for Gedssd but I am just trying to model this after Sceptar and 8pi because those seem somewhat simialr
    kGedssdEdep,
    kGedssdEdepSum,
    kGedssdEdepDet0,
    kGedssdEdepDet1,
    ...
    kGedssdEdepDet8,
    kGedssdEdepDet9,
//I originally had 19 like the others, but I only have 9 detectors so I took them out to see what will happen.
//End of additional detectors
    kSpiceCrystalEdep,
