...
//Need to add similar part for Gedssd so I can use the Messenger for it as well
    fAddDetectionSystemGedssdCmd = new G4UIcmdWithAnInteger("/DetSys/det/addGedssd",this);
    fAddDetectionSystemGedssdCmd->SetGuidance("Add Detection System Gedssd");
    fAddDetectionSystemGedssdCmd->AvailableForStates(G4State_PreInit,G4State_Idle);
//end of new addition	 
