...
//Adding a function to incorporate the Gedssd
    void GedssdDet(G4double de, G4double dl, G4int det) { fGedssdEnergyDet[det] += de; fGedssdTrackDet[det] += dl;} ;
...
private:
    ...
    G4double fGedssdEnergyDet[MAXNUMDET] ;
    G4double fGedssdTrackDet[MAXNUMDET] ;
